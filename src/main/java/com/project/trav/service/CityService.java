...
public class CityService {
    ...
    public List<CityDto> getCities(){return cityMapper.toCityDtos(cityRepository.findAll());}

    public CityDto getCityInfo(String name) {
        return cityMapper.toCityDto(findByNameCity(name));
    }
    public void addCity(CityDto cityDto){ cityRepository.save(cityMapper.toCity(cityDto));}
